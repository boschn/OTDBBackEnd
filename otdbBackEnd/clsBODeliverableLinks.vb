...
#End Region
    ...
    Public Class CurrentLink
        ...
        <ormObjectEntry(datatype:=otDataType.Long, defaultvalue:=0, _
                        lowerrange:=0, PrimaryEntryOrdinal:=1, XID:="DLVCL1", title:="link uid", description:="uid of the deliverable link")> _
   ...
   <ormObject(id:=Link.ConstObjectID, description:="describes a link from other deliverables", _
    ...
    Public Class Link
       ...
       <ormTableAttribute(Version:=1)> Public Const ConstPrimaryTableID = "TBLDELIVERABLELINKS"
        ...
        ''' </summary>
        ''' <remarks></remarks>
        <ormObjectEntry(referenceObjectEntry:=CurrentLink.ConstObjectID & "." & CurrentLink.ConstFNLinkUid, PrimaryEntryOrdinal:=1, _
          lowerrange:=0, XID:="DLVL1")> Public Const ConstFNLinkUid = "LUID"

        <ormObjectEntry(Datatype:=otDataType.Long, title:="update count", Description:="Update count of the link", PrimaryEntryOrdinal:=2, _
            lowerrange:=0, XID:="DLVL2")> Public Const ConstFnLinkUpdc = "UPDC"
