...
#End Region
        ...
        Public Shared Function AvailableDays(ByVal fromdate As Date, ByVal untildate As Date, _
            ...
            '** run sqlstatement
            Try
                Dim aStore = ot.GetTableStore(ConstPrimaryTableID)
        ...
        Public Shared Function NextAvailableDate(ByVal fromdate As Date, ByVal noDays As Integer, _
            ...
            '**
            Try
                Dim aStore = GetTableStore(ConstPrimaryTableID)
                ...
                If Not aCommand.IsPrepared Then
                    ...
                    Else
                        ...
                        CoreMessageHandler(message:="DatabaseType not recognized for SQL Statement", messagetype:=otCoreMessageType.InternalError, _
                                           procedure:="CalendarEntry.HasDate", containerID:=ConstPrimaryTableID, argument:=aCommand.DatabaseDriver.DatabaseType)
                        Return False
                    End If
            ...
            Try
                ...
                If Not aCommand.IsPrepared Then
                    ...
                    Else
                        ...
                        CoreMessageHandler(message:="DatabaseType not recognized for SQL Statement", messagetype:=otCoreMessageType.InternalError, _
                                           procedure:="CalendarEntry.AllByDate", containerID:=ConstPrimaryTableID, argument:=aCommand.DatabaseDriver.DatabaseType)
                        Return aCollection
                    End If
        ...
        Public Shared Function Create(Optional ByVal name As String = Nothing, Optional entryid As Long = 0, Optional domainid As String = Nothing) As CalendarEntry
            ...
            If entryid = 0 Then
                ...
                If Not ot.GetTableStore(ConstPrimaryTableID).CreateUniquePkValue(pkarray) Then
