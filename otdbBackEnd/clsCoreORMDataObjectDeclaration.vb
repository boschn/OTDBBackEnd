...
Namespace OnTrack.Database
    ...
    Public Interface iormDataObject
        ...
        ''' <summary>
        ''' returns the GUID of the object instance
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <summary>
        ''' returns true if the object was changed since the last persist
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
    ...
    Public Interface iormPersistable
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function Inject(ByRef primarykey As ormDatabaseKey, _
                        Optional domainid As String = Nothing, _
    ...
    Public Interface iormRelationalPersistable
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        ReadOnly Property DatabaseDriver As iormRelationalDatabaseDriver
        ''' <summary>
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        ReadOnly Property PrimaryTableStore As iormRelationalTableStore
    ...
    Public Interface iormInfusable
        ...
        ''' </summary>
        ''' <param name="entryname"></param>
        ''' <param name="fieldmembername"></param>
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function GetValue(entryname As String, Optional ByRef fieldmembername As String = Nothing) As Object
