...
Namespace OnTrack.Database
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Interface iormPrimaryDriver
    ...
    Public Interface iormDatabaseDriver
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        ReadOnly Property IsPrimaryDriver As Boolean
        ...
        ''' <summary>
        ''' gets or sets the id of the relational database driver
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        ''' <summary>
        ''' returns the driver type of this relational database driver
        ''' </summary>
        ''' <value></value>
        ''' <returns></returns>
        ''' <remarks></remarks>
        ...
        Function GetForeignKeys(nativeContainerObject As Object, _
                                foreignkeydefinition As ForeignKeyDefinition, _
        ...
        Function GetIndex(ByRef nativeTable As Object, _
                          ByRef indexdefinition As IndexDefinition,
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function VerifyContainerSchema(containerAttribute As iormContainerAttribute, _
                                   Optional ByRef connection As iormConnection = Nothing, _
                                   Optional nativeConnection As Object = Nothing) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function VerifyContainerEntrySchema(containerEntryDefinition As ContainerEntryDefinition, _
                                    Optional ByRef connection As iormConnection = Nothing, _
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function VerifyContainerEntrySchema(attribute As iormContainerEntryAttribute, _
                                    Optional ByRef connection As iormConnection = Nothing, _
                                    Optional silent As Boolean = False) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function GetContainerEntryObject(nativeContainerObject As Object, containerEntryDefinition As ContainerEntryDefinition, _
                           Optional ByVal createOrAlter As Boolean = False, _
                           Optional ByRef connection As iormConnection = Nothing) As Object
    End Interface
    ...
    Public Interface iormRelationalDatabaseDriver
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function VerifyTableSchema(tabledefinition As ContainerDefinition, _
                                   Optional ByRef connection As iormConnection = Nothing, _
                                   Optional nativeConnection As Object = Nothing) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function VerifyColumnSchema(containerEntryDefinition As ContainerEntryDefinition, _
                                    Optional ByRef connection As iormConnection = Nothing, _
                                    Optional silent As Boolean = False) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function VerifyColumnSchema(attribute As iormContainerEntryAttribute, _
                                    Optional ByRef connection As iormConnection = Nothing, _
                                    Optional silent As Boolean = False) As Boolean
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function GetColumn(nativeTable As Object, columndefinition As ContainerEntryDefinition, _
                           Optional ByVal createOrAlter As Boolean = False, _
                           Optional ByRef connection As iormConnection = Nothing) As Object
