...
Namespace OnTrack.Configurables
    ...
    Public Class Configuration
        ...
        ''' </summary>
        ''' <remarks></remarks>
        <ormSchemaTable(version:=1, usecache:=True)> Public Const ConstTableID = "TBLDEFCONFIGURATION"
...
#End Region
        ...
        Public Shadows Sub OnCreating(sender As Object, e As ormDataObjectEventArgs) Handles MyBase.OnCreating
            ...
            If Not uid.HasValue OrElse uid = 0 Then
                ...
                If e.DataObject.PrimaryTableStore.CreateUniquePkValue(pkArray:=primarykey) Then
                    ...
                    e.Proceed = True
                Else
                    CoreMessageHandler(message:="primary keys could not be created ?!", subname:="Configuration.OnCreate", messagetype:=otCoreMessageType.InternalError)
                End If
            End If
        End Sub
        ''' <summary>
        ...
        Public Overloads Shared Function Create(id As String, Optional uid As Long = 0, Optional domainid As String = "")
            ...
            End With
            Return ormDataObject.CreateDataObject(Of Configuration)(aRecord, domainID:=domainid, checkUnique:=True)
        End Function
            ...
            If my IsNot Nothing Then
                ...
                If Not idno.HasValue OrElse idno = 0 Then
                    ...
                    If e.DataObject.PrimaryTableStore.CreateUniquePkValue(pkArray:=primarykey) Then
                        ...
                        e.Proceed = True
                    Else
                        CoreMessageHandler(message:="primary keys could not be created ?!", subname:="ConfigCondition.OnCreate", _
